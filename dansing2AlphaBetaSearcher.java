...
public class dansing2AlphaBetaSearcher implements GameTreeSearcher {
	...
	public dansing2AlphaBetaSearcher (int depthLimit) {
	...
	public double alphabetaEval(GameNode node, int depthLeft, double alpha, double beta) {
		...
		// Collections.sort(children, new MancalaNodeComparator());
